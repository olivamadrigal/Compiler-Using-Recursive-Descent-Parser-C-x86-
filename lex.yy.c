...
#define TEST_FILE "/home/samiracoliva/Documents/CMPE152/LabAssignments/lab3/ASSEMBLY_FILE.asm"
FILE *spOut;
int   count;
...
bool TPrime(void)
{
    ...
    {   
	    ...
	    fprintf(spOut,"\t%s\n","pop ebx");//multiplier
	    fprintf(spOut,"\t%s\n","imul ebx");//MUL eax by ebx
	    //fprintf(spOut,"\t%s\n","push edx");//upper 32-bits
	    fprintf(spOut,"\t%s\n","push eax");//lower 32-bits
            return TPrime();
        }
        else
        {
